const IMAGES = {
	batatabit: require("../assets/img/batatabit.jpg").default,
	blog: require("../assets/img/blog.jpg").default,
	flowskip: require("../assets/img/flowskip.jpg").default,
	form: require("../assets/img/form.jpg").default,
