export const translations = {
  en: {
    ...
    about: {
      ...
      description: {
        ...
        secondParagraph:
          "I'm interested in high-impact projects that allow me to combine different frameworks and technologies, culminating in delivering added value to its users.",
        thirdParagraph:
          ...
          career: [
            {
              ...
              end_date: "Present",
              description: [
                "Platzi Master is an intensive and elite program, where only 0.01% of the best students on the platform are accepted, to turn them into the next generation of the best professionals in the technology industry, with 1:1 support from specialized and recognized technical trainers in the industry. 💻",
                "I am an education enthusiast, so I am constantly learning foreign languages like English, and French, programming languages, and public speaking, as they are tools that will help me share with more people and grow together. 💚",
              ],
            },
          ],
          ...
          career: [
            {
              ...
              end_date: "June 2021",
              description: [
                "I studied the career of computer science, where I learned the basics of various programming languages and web development.",
                "I also did internships and professional projects in which I was able to develop my skills and practice my knowledge of web development.",
              ],
            },
          ],
        },
          ...
          positions: [
            {
              ...
              end_date: "July 2023",
              description:
                "Contributed to the quality assurance of the content, working together with different teams to deliver a high quality product used by more than 3 million students in Latin America.",
              bullets: [
                "Providing continuous feedback to the team to iterate on better results.",
                "Reducing the rate of student-reported content errors by 66%.",
                "Reducing the rate of students affected by content errors by 68%.",
              ],
              skills: [
                "Quality Assurance",
            ...
            },
            {
              ...
              end_date: "July 2022",
              description:
                "Contributed to the creation, revision, and improvement of the content in the platform classes, mainly in technology courses. Creation and continuous improvement of the content for the platform classes.",
              bullets: [
                "Generate quality content for Platzi students.",
                "Improved the SEO of the platform.",
          ...
          positions: [
            {
              ...
              description:
                "Developing a web application for the La Paz, Bolivia mayor's office. Using technologies like JavaScript, SCSS, storybook, and some JavaScript libraries like React, Next.js, besides using Redux-Saga, and other libraries.",
              bullets: [
                "Working on the creation and implementation of the logic of the modules for the users.",
                "Creating flows of citizen participation: voting, creation of proposals, etc.",
                "Connecting views with REST APIs.",
              ],
          ...
          positions: [
            {
              ...
              description:
                "Development and maintenance of code for internal and external client websites using HTML, CSS, Sass, JavaScript, React, Firebase, WordPress, and more.",
              bullets: [
                "Sites manually tested across multiple browsers and mobile devices to ensure cross-browser compatibility and responsiveness.",
                "Developing high quality websites for internal and external clients.",
              ],
              skills: [
                "HTML",
                "CSS",
    ...
    projects: {
      ...
      title: "Projects",
      description:
        "Throughout my career as a Frontend, I have had the opportunity of working on incredible and challenging projects. Here are some projects that I would like to share.",
      list: [
        {
          name: "Movies App",
          description:
        ...
        },
        {
          name: "Portfolio",
          description:
            "This is the portfolio that you are seeing right now, I made it with react and typescript, and I used sass for the styles.",
          github: "https://github.com/BrandonArgel/brandonargel.github.io",
          image: "portfolio",
        },
        {
          name: "ToDo App",
    ...
    contact: {
      ...
      description: {
        current:
          "I am always looking for new challenges and job opportunities.",
        invite:
  ...
  es: {
    ...
    about: {
      ...
      description: {
        firstPart:
          "¡Hola! Mi nombre es Brandon Argel Verdeja Domínguez, y tengo",
        secondPart: "años.",
        secondParagraph:
          "Estoy interesado en proyectos de alto impacto que me permitan combinar diferentes frameworks y tecnologías, culminando en entregar valor agregado a sus usuarios.",
        thirdParagraph:
          "Soy un entusiasta de la educación, por lo que sigo aprendiendo constantemente idiomas extranjeros como inglés, francés, lenguajes de programación y hablar en público, ya que son herramientas que me ayudarán a compartir con más personas y crecer juntos.",
      },
      studies:
    ...
    education: {
      ...
      schools: [
          ...
          career: [
            {
              ...
              start_date: "Septiembre 2018",
              end_date: "Actualidad",
              description: [
                "Platzi Master es un programa intensivo y de élite, donde solo se acepta el 0.01% de los mejores estudiantes de la plataforma, para convertirlos en la próxima generación de los mejores profesionales de la industria tecnológica, con apoyo 1:1 de técnicos especializados y reconocidos entrenadores en la industria. 💻",
                "Soy un entusiasta de la educación, por lo que estoy constantemente aprendiendo idiomas extranjeros como inglés y francés, lenguajes de programación y hablar en público, ya que son herramientas que me ayudarán a compartir con más personas y crecer juntos. 💚",
              ],
            },
          ],
        },
        {
          ...
          career: [
            {
              title: "Tecnólogo Profesional en Informática",
              start_date: "Julio 2017",
              end_date: "Junio 2021",
              description: [
                "Estudié la carrera de informática, donde aprendí las bases de varios lenguajes de programación y desarrollo web.",
                "También realicé pasantías y proyectos profesionales en los que pude desarrollar mis habilidades y practicar mis conocimientos de desarrollo web.",
              ],
            },
          ],
        },
          ...
          positions: [
            {
              ...
              end_date: "Julio 2023",
              description:
                "Contribuí al aseguramiento de la calidad del contenido, trabajando en conjunto con diferentes equipos para entregar un producto de alta calidad utilizado por más de 3 millones de estudiantes en América Latina.",
              bullets: [
                "Proveer feedback continuo al equipo para iterar en mejores resultados.",
                "Redujimos la tasa de errores de contenido informados por los estudiantes en un 66 %.",
                "Redujimos la tasa de estudiantes afectados por errores de contenido en un 68 %.",
              ],
              skills: [
                "Control de calidad",
            ...
            {
              title: "Creador de contenido SEO",
              start_date: "Mayo 2022",
              end_date: "Julio 2022",
              description:
                "Contribuí con la creación, revisión y mejora de los contenidos en las clases de la plataforma, principalmente en los cursos de tecnología. Creación y mejora continua del contenido para las clases en la plataforma.",
              bullets: [
                "Generamos contenido de calidad para los estudiantes de Platzi.",
                "Mejoramos el SEO de la plataforma.",
                "Creamos y mejoramos el contenido.",
              ],
              skills: [
          ...
          positions: [
            {
              ...
              description:
                "Desarrollando una aplicación web para la alcaldía La Paz, Bolivia. Usando tecnologías como JavaScript, SCSS, storybook, y algunas librerías de JavaScript como React, Next.js, además de usar Redux-Saga, y otras librerías.",
              bullets: [
                "Trabajamos en la creación e implementación de la lógica de los módulos para los usuarios.",
                "Creamos flujos de participación ciudadana: votaciones, creación de propuestas, etc.",
                "Conectamos vistas con REST APIs.",
              ],
              skills: ["JavaScript", "SCSS", "React", "Next.js", "Redux-Saga"],
            },
          ],
          ...
          positions: [
            {
              ...
              description:
                "Desarrollo y mantenimiento de código para sitios web de clientes internos y externos utilizando HTML, CSS, Sass, JavaScript, React, Firebase, Wordpress y más.",
              bullets: [
                ...
                "Desarrollamos sitios web de alta calidad para clientes internos y externos.",
              ],
              skills: [
                "HTML",
                "CSS",
    ...
    projects: {
      ...
      title: "Proyectos",
      description:
        "A lo largo de mi carrera como Frontend, he tenido la oportunidad de trabajar en increíbles y proyectos desafiantes. Aquí hay algunos proyectos que me gustaría compartir.",
      list: [
        {
          name: "Movies App",
          description:
        ...
        },
        {
          name: "Portfolio",
          description:
            "Este es el portafolio que estás viendo ahora, lo hice con react y typescript, y usé sass para los estilos.",
          github: "https://github.com/BrandonArgel/brandonargel.github.io",
          image: "portfolio",
        },
        {
    ...
    contact: {
      ...
      description: {
        current:
          "Siempre estoy buscando nuevos desafíos y oportunidades de trabajo.",
        invite:
  ...
  fr: {
    ...
    about: {
      ...
      description: {
        firstPart:
          "Salut! Je m'appelle Brandon Argel Verdeja Domínguez, et j'ai",
        secondPart: "ans.",
        secondParagraph:
          "Je suis intéressé par les projets à fort impact qui me permettent de combiner différents frameworks et technologies, aboutissant à apporter une valeur ajoutée à ses utilisateurs.",
        thirdParagraph:
          "Je suis un passionné d'éducation, donc j'apprends constamment des langues étrangères comme l'anglais, le français, les langages de programmation et la prise de parole en public, car ce sont des outils qui m'aideront à partager avec plus de gens et à grandir ensemble.",
      },
      studies:
    ...
    education: {
      ...
      schools: [
          ...
          career: [
            {
              ...
              description: [
                "Platzi Master est un programme intensif et élitiste, où seuls 0,01 % des meilleurs étudiants de la plateforme sont acceptés, pour en faire la prochaine génération des meilleurs professionnels de l'industrie technologique, avec un soutien 1: 1 de techniciens spécialisés et reconnus formateurs de l'industrie. 💻",
                "Je suis un passionné d'éducation, donc j'apprends constamment des langues étrangères comme l'anglais et le français, les langages de programmation et la prise de parole en public, car ce sont des outils qui m'aideront à partager avec plus de gens et à grandir ensemble. 💚",
              ],
            },
          ],
        },
        {
          ...
          career: [
            {
              title: "Technologue en informatique professionnel",
              start_date: "Juillet 2017",
              end_date: "Juin 2021",
              description: [
                "J'ai étudié l'informatique, où j'ai appris les bases de divers langages de programmation et du développement web.",
                "J'ai également effectué des stages et des projets professionnels où j'ai pu développer mes compétences et mettre en pratique mes connaissances en développement web.",
              ],
            },
          ],
        },
          ...
          positions: [
            {
              ...
              description:
                "J'ai contribué à l'assurance qualité du contenu, en travaillant avec différentes équipes pour fournir un produit de haute qualité utilisé par plus de 3 millions d'étudiants en Amérique latine.",
              bullets: [
                "Fournir des commentaires continus à l'équipe pour itérer sur de meilleurs résultats.",
                "Nous avons réduit le taux d'erreurs de contenu signalées par les étudiants de 66 %.",
                "Réduction de 68 % du taux d'étudiants affectés par des erreurs de contenu.",
              ],
              skills: [
                "Assurance qualité",
            ...
            {
              title: "Créateur de contenu SEO",
              start_date: "Peut 2022",
              end_date: "Juillet 2022",
              description:
                "J'ai contribué à la création, à la révision et à l'amélioration du contenu des cours de la plateforme, principalement dans les cours de technologie. Création et amélioration continue du contenu des cours de la plateforme.",
              bullets: [
                "Nous générons du contenu de qualité pour les étudiants de Platzi.",
                "Nous avons amélioré le référencement de la plateforme.",
                "Nous créons et améliorons le contenu.",
              ],
              skills: [
          ...
          positions: [
            {
              ...
              description:
                "Développement d'une application Web pour le bureau du maire de La Paz, en Bolivie. Utilisation de technologies telles que JavaScript, SCSS, storybook et certaines bibliothèques JavaScript telles que React, Next.js, en plus d'utiliser Redux-Saga et d'autres bibliothèques.",
              bullets: [
                "Nous travaillons sur la création et la mise en place de la logique des modules pour les utilisateurs.",
                "Nous créons des flux de participation citoyenne : vote, création de propositions, etc.",
                "Nous connectons les vues avec les API REST.",
              ],
              skills: ["JavaScript", "SCSS", "React", "Next.js", "Redux-Saga"],
            },
          ],
          ...
          positions: [
            {
              ...
              description:
                "Développement et maintenance de code pour les sites Web de clients internes et externes utilisant HTML, CSS, Sass, JavaScript, React, Firebase, Wordpress et plus.",
              bullets: [
                "Sites testés manuellement sur plusieurs navigateurs et appareils mobiles pour garantir la compatibilité et la réactivité entre navigateurs.",
                "Nous développons des sites Web de haute qualité pour des clients internes et externes.",
              ],
              skills: [
                "HTML",
                "CSS",
    ...
    projects: {
      ...
      title: "Projets",
      description:
        "Tout au long de ma carrière en tant que Frontend, j'ai eu l'opportunité de travailler sur des projets incroyables et des projets exigeants. Voici quelques projets que j'aimerais partager.",
      list: [
        {
          name: "Movies App",
          description:
        ...
        },
        {
          name: "Portefeuille",
          description:
            "C'est le portfolio que vous regardez maintenant, je l'ai fait avec React et Tapuscrit, et j'ai utilisé du sass pour les styles.",
          github: "https://github.com/BrandonArgel/brandonargel.github.io",
          image: "portfolio",
        },
        {
    ...
    contact: {
      ...
      description: {
        current:
          "Je suis toujours à la recherche de nouveaux défis et d'opportunités professionnelles.",
        invite:
