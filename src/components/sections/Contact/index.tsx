...
const Contact = () => {
  ...
  const [hasSent, setHasSent] = React.useState(
    localStorage.getItem('sentForm') === 'true',
  );
  ...
  const validateEmail = (value: string) => {
    if (!value) setEmail({ ...email, error: contact.errors.email.required });
      ...
      setEmail({ ...email, error: contact.errors.email.invalid });
    else return true;
  };

  const validateMessage = (value: string) => {
    if (!value)
      setMessage({ ...message, error: contact.errors.message.required });
  ...
  return (
    <section className={styles.contact} id={contact.id} ref={sectionRef}>
      ...
      <p className={styles.contact__description}>
        {contact.description.current}
      </p>
      <p className={styles.contact__description}>
        {contact.description.invite}
      </p>
