...
import Pdf from "../docs/curriculum.pdf";
          ...
          <section className="main__hero fadeInLeft">
            <div id="main__hero--text">
              ...
              <div className="main__hero--presentation">
                <div id="name" className="main__hero--animated-name">
                  Brandon Argel.
                </div>
                <p className="main__hero--presentation-do">
                  Yo construyo sitios web.
                </p>
              </div>
              <p className="main__hero--info">
                Soy un
                <span className="main__hero--info-career">
                  {" "}
                  Frontend Developer{" "}
                </span>
                en constante aprendizaje y evolución que vive en la ciudad de
                Guadalajara, México y me especializo en construir sitios web.
              </p>
            </div>
            <div className="main__hero--buttons">
              <Button
                href="mailto:brandargel@gmail.com"
